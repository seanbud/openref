...
class ThemeWidget(RadioGroup):
    ...
    OPTIONS = (
        ...
        ('sakura', 'Sakura',
         'Luminous berry surfaces with soft blossom accents.'),
        ('sakura-night', 'Sakura Night',
         'Restrained ink-dark plum with muted blossom accents.'),
        ('ocean', 'Deep Ocean',
         'Near-black navy surfaces with clear turquoise accents.'),
        ('forest', 'Forest',
         'Evergreen surfaces with quiet moss and fern accents.'),
        ('citrus', 'Citrus Dusk',
         'Warm cocoa surfaces with amber and apricot accents.'),
        ('lavender', 'Lavender Haze',
         'Velvet indigo surfaces with luminous lilac accents.'),
        ('paper', 'Warm Paper',
